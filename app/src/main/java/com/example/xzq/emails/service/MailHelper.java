package com.example.xzq.emails.service;
...
public class MailHelper {
    ...
    public List<MailReceiver> getAllMail(String folderName) throws MessagingException {
        ...
        store.connect(host, MyApplication.info.getUserName(), String.valueOf(MyApplication.info.getPassword()));
        // 打开文件夹
