package com.example.xzq.emails.utils;

import com.example.xzq.emails.app.MyApplication;
import com.example.xzq.emails.bean.Attachment;
import com.example.xzq.emails.bean.MailInfo;
import com.example.xzq.emails.bean.MyAuthenticator;
...
public class HttpUtil {
    ...
    private Session isLoginRight(MailInfo info) {
        ...
        try {
            ...
            transport.connect(info.getMailServerHost(), info.getUserName(), String.valueOf(info.getPassword()));
